...
go get github.com/RaphaelMaschinsen/talkiepi

cd $GOPATH/src/github.com/RaphaelMaschinsen/talkiepi
...
```
cp /home/mumble/gocode/src/github.com/RaphaelMaschinsen/talkiepi/conf/systemd/mumble.service /etc/systemd/system/mumble.service
